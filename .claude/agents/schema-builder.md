...
2. `ecosystem.json`에서 DB 타입 판별 (Neon / D1 / Durable Objects SQLite).
   권위는 `canon/project-infrastructure-registry.md`, 갈리면 **그 repo 실측이 SoT**.
   ⚠ `Turso` 는 2026-08-16 실측 0건 — dialect 를 잘못 고르면 조용히 틀린 스키마가 나온다.
