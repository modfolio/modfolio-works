...
### Freshness Check (권장, 작성자 판단)

컴포넌트 생성 전 참고:
1. 이 앱에서 최근 만든 유사 컴포넌트 몇 개 훑기
2. 구조적 반복이 느껴지면 차별화 포인트(레이아웃 / 비율 / 모션 등) 탐색
3. 수치 임계(80% 등)는 두지 않음 — 반복 여부는 작성자가 판단

참조: knowledge/canon/design-innovation.md (검출 도구, 처방 아님)
